...
{
    public class SolicitudHogwartsInMemoryRepositpory : IRepositorySolicitudHogwartsInMemory<SolicitudHogwarts, int>
    {
            ...
            /// </summary>
            public SolicitudHogwartsInMemoryRepositpory(InmemoryDbContext context)
            {
                _context = context;
            }
            ...
            public SolicitudHogwarts Add(SolicitudHogwarts _entity)
            {
                ...
                _context.solicitudHogwarts.Add(_entity);    //Agrego la Entidad SolicitudHogwarts que es el DbSet en la clase InmemoryDbContext
                return _entity;
            }
