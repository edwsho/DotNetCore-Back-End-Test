...
namespace BackEndPortafolioTarjeta.Controllers
{
    ...
    [ApiController]
    public class SolicitudHogwartsInMemory : ControllerBase
    {
        SolicitudHogwartsServicesInMemory CreateSolicitudHogwartsServices()
        {
            InmemoryDbContext _context = new InmemoryDbContext();                                             // Obtengo el Contexto para acceder a la Base de Datos
            SolicitudHogwartsInMemoryRepositpory _repo = new SolicitudHogwartsInMemoryRepositpory(_context);  // Intancio el Repositorio con el Contexto, Aca estan los Casos de Uso
            SolicitudHogwartsServicesInMemory _services = new SolicitudHogwartsServicesInMemory(_repo);       // Intancio el Servicio con el repositorio el cual quiero trabajar en este Controller

            return _services;
        }

        // GET api/Tarjeta/GetSolicitud
        /// <summary>
