...
namespace BackEndPortafolioTarjeta.Application.Services
{
    ...
    /// </summary>
    public class SolicitudHogwartsServicesInMemory : IServiceSolicitudHogwartsInMemory<SolicitudHogwarts, int>
    {
        private readonly IRepositorySolicitudHogwartsInMemory<SolicitudHogwarts, int> repoSolicitudHogwarts2; //private readonly IRepositoryBase<SolicitudHogwarts, int> repoSolicitudHogwarts;

        /// <summary>
        /// Al momento de instanciar el servicio se pasa por parametros el repositorio el cual se va a utilizar.
        /// </summary>
        public SolicitudHogwartsServicesInMemory(IRepositorySolicitudHogwartsInMemory<SolicitudHogwarts, int> _repoSolicitudHogwarts2)
        {
